...
func (k Kfc) GetMenu() string {
	return "Fried Chicken,Zinger Burger,Pepsi"
}
...
func (b Burger) PrepareFood() string {
	return "Preparing Whopper Burger "
}

func (b Burger) GetMenu() string {
	return "Whopper, Onion Rings, Sprite"
}

func (b Burger) GetLocation() string {
	return b.location
}

func Operate(fr Franchise) {
	fmt.Println("Food:", fr.PrepareFood())
	fmt.Println("Menu:", fr.GetMenu())
