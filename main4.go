...
func main() {
	...
	Write a Go program that:
		...
		2.	Passes their addresses to a function
		3.	Inside the function:
		•	Swap the values
		4.	Print the values before and after the function call
	...
	*/
	...
	a := 10
	var d0 *int
	fmt.Println(*d0) // so this will print out nil because the default value of pointer variable is nil
	fmt.Println("Before the swap :", c, a)

	Swap(&c, &a)
	fmt.Println("After the swap :", c, a)

}

func Swap(a1 *int, a2 *int) {
	// a1 --->will contain address
	// *a1 will have the value
	var temp int
	temp = *a1
	*a1 = *a2
	*a2 = temp
