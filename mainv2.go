...
//	//fmt.Println("a: ", a, ", b: ", b)
//
//	//Short2(2, 3, "hello", "world")
//	//Short(2, 3, "hello", "world")
//
//	a, _ := Divisible(4, 2)
//	fmt.Println(a)
//}
...
//}
//
//func namedReturn(d string) (x int, y int) {
//	x = 2
//	y = 3
//	return
//}
...
//}
//
//func Short(x int, y int, z string, s string) {
//
//}
//
//func Short2(x, y int, z, s string) {
//
//}
//
//func Divisible(a, b int) (int, string) {
//	if b == 0 {
